    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('owner', 'Владелец'), ('buyer', 'Покупатель'), ('tenant', 'Арендатор'), ('bank', 'Банк'), ('agent', 'Риелтор'), ('advertiser', 'Рекламодатель')], default='buyer', max_length=20, verbose_name='Роль')),
